...
@Component
public class KafkaRecordRepository {

    private static final String TABLE_NAME = "Record2";
    ...
    @Autowired
    public KafkaRecordRepository(HbaseClient hbaseClient) {
    ...
    public List<Record> findTrackByEid(String eid)
    {
